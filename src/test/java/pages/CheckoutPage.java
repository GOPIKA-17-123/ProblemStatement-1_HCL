...
public class CheckoutPage extends BasePage {
    ...
    By orderSuccessText = By.xpath("//b[contains(text(),'Order Placed!')]");
    ...
    public void proceedToCheckout(){
        ...
        clickUsingJS(proceedToCheckoutBtn);
    }
    ...
    public void enterPaymentDetails(){
        ...
        driver.findElement(nameOnCard).sendKeys("Gopika");
    ...
    public boolean isOrderPlaced(){
        ...
        return driver.findElement(orderSuccessText).isDisplayed();
    }
    public boolean isRedirectedToLogin(){
        waitForElement(registerLoginBtn);
        return driver.findElement(registerLoginBtn).isDisplayed();
    }
}